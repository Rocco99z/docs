...
import type { PasswordProps, SearchProps, TextAreaProps, GroupProps } from "antd/es/input"
import type { CheckboxGroupProps } from "antd/es/checkbox"
import type { RangePickerProps } from "antd/es/date-picker"
import type { DraggerProps } from "antd/es/upload"

type FormFieldProps<T> = React.FC<T & FormItemProps & { span?: number | string }>
...
export const FormInputNumber: FormFieldProps<InputNumberProps> = createField(InputNumber)
